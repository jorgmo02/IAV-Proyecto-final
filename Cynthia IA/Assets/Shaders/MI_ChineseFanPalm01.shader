Shader "Unreal/MI_ChineseFanPalm01"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.285907,0.357639,0.173852,1.000000);//
	Material.VectorExpressions[2] = float4(0.285907,0.357639,0.173852,0.000000);//
	Material.VectorExpressions[3] = float4(0.100000,0.100000,0.100000,1.000000);//
	Material.VectorExpressions[4] = float4(0.100000,0.100000,0.100000,0.000000);//
	Material.VectorExpressions[5] = float4(0.000000,0.000000,0.000000,0.000000);//
	Material.VectorExpressions[6] = float4(1.500000,1.283495,0.549568,1.000000);//
	Material.VectorExpressions[7] = float4(1.500000,1.283495,0.549568,0.000000);//
	Material.VectorExpressions[8] = float4(0.217902,0.255208,0.152859,0.000000);//
	Material.VectorExpressions[9] = float4(0.217902,0.255208,0.152859,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.000000,3.000000);
	Material.ScalarExpressions[1] = float4(0.750000,1.000000,0.000000,0.500000);
