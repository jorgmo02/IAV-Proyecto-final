		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,1.000000);
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,2.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local5 = Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local6 = lerp(Material.ScalarExpressions[1].y,Material.ScalarExpressions[1].x,Local5.g);
	MaterialFloat2 Local7 = (Parameters.TexCoords[0].xy * Material.ScalarExpressions[1].z);
	MaterialFloat4 Local8 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local7,View.MaterialTextureMipBias);
	MaterialFloat Local9 = (1.00000000 - Local8.r);
