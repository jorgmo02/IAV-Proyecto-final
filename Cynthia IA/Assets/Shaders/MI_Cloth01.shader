		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(3.000000,3.000000,3.000000,1.000000);//
	Material.VectorExpressions[3] = float4(3.000000,3.000000,3.000000,0.000000);//
	Material.VectorExpressions[4] = float4(0.526042,0.044825,0.021918,1.000000);//
	Material.VectorExpressions[5] = float4(0.526042,0.044825,0.021918,0.000000);//
	Material.ScalarExpressions[0] = float4(15.000000,1.000000,0.000000,1.000000);
	Material.ScalarExpressions[1] = float4(0.000000,0.500000,1.000000,0.000000);
	Material.ScalarExpressions[2] = float4(0.100000,0.400000,0.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = (Material.VectorExpressions[3].rgb * Local4.rgb);
	MaterialFloat3 Local6 = (Material.VectorExpressions[5].rgb * Local5);
	MaterialFloat2 Local7 = (Parameters.TexCoords[0].xy * Material.ScalarExpressions[0].w);
	MaterialFloat4 Local8 = Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local7,View.MaterialTextureMipBias);
	MaterialFloat3 Local9 = lerp(Local5,Local6,MaterialFloat(Local8.r));
	MaterialFloat4 Local10 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local11 = lerp(Material.ScalarExpressions[1].w,Material.ScalarExpressions[1].z,Local10.g);
	MaterialFloat Local12 = lerp(Local11,Material.ScalarExpressions[2].x,Local8.r);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local9,Material.ScalarExpressions[2].z);
