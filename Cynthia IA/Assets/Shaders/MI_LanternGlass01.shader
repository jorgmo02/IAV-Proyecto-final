Shader "Unreal/MI_LanternGlass01"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.949380,0.682292,1.000000);//
	Material.VectorExpressions[3] = float4(1.000000,0.949380,0.682292,0.000000);//
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,0.000000,1.000000);
	Material.ScalarExpressions[1] = float4(0.190476,0.150000,0.940000,1.000000);
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = lerp(Local2.rgb,Material.VectorExpressions[3].rgb,Local4);
	...
	MaterialFloat Local7 = lerp(Material.ScalarExpressions[0].z,Material.ScalarExpressions[0].y,Local6.g);
	...
	MaterialFloat Local12 = lerp(Material.ScalarExpressions[1].y,Material.ScalarExpressions[1].x,Local11);
	MaterialFloat3 Local13 = (Local3.rgb * Local12);
	MaterialFloat Local14 = lerp(Material.ScalarExpressions[1].w,Material.ScalarExpressions[1].z,Local11);
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(Local14,Material.ScalarExpressions[2].x);
