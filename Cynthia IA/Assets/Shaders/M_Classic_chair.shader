...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local3 = dot(Local2.rgb, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local4 = lerp(Local2.rgb,MaterialFloat3(Local3,Local3,Local3),MaterialFloat(0.30000001));
	MaterialFloat4 Local5 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Roughness = Local5.g;
