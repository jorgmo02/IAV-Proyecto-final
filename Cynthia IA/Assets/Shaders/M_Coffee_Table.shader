		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.086806,0.043299,0.018687,0.000000);//
	Material.VectorExpressions[3] = float4(0.086806,0.043299,0.018687,0.000000);//
	Material.VectorExpressions[4] = float4(0.674510,0.674510,0.674510,0.000000);//
	Material.VectorExpressions[5] = float4(0.674510,0.674510,0.674510,0.000000);//
	Material.VectorExpressions[6] = float4(0.041667,0.041667,0.041667,0.000000);//
	Material.VectorExpressions[7] = float4(0.041667,0.041667,0.041667,0.000000);//
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local1 = Texture2DSampleBias(Material_Texture2D_0, Material_Texture2D_0Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat3 Local2 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[3].rgb,MaterialFloat(Local1.r));
	MaterialFloat3 Local3 = lerp(Local2,Material.VectorExpressions[5].rgb,MaterialFloat(Local1.g));
	MaterialFloat3 Local4 = lerp(Local3,Material.VectorExpressions[7].rgb,MaterialFloat(Local1.b));
	MaterialFloat Local5 = (1.00000000 * Local1.g);
	MaterialFloat Local6 = lerp(0.00000000,0.20000000,Local1.r);
	MaterialFloat Local7 = lerp(Local6,0.15000001,Local1.g);
	MaterialFloat Local8 = lerp(Local7,0.50000000,Local1.b);
