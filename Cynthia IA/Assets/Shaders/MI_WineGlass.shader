		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.706977,0.817708,0.806618,1.000000);//
	Material.VectorExpressions[3] = float4(0.706977,0.817708,0.806618,0.000000);//
	Material.ScalarExpressions[0] = float4(0.000000,5.000000,0.050000,1.500000);
	Material.ScalarExpressions[1] = float4(5.000000,1.000000,0.940000,1.000000);
