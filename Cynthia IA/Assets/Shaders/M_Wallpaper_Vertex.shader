Shader "Unreal/M_Wallpaper_Vertex"
{
	Properties
	{
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local1 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat3 Local2 = lerp(Local0.rgb,Local1.rgb,MaterialFloat(Parameters.VertexColor.r));
	...
	MaterialFloat4 Local5 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat3 Local6 = lerp(Local4.rgb,Local5.rgb,MaterialFloat(Parameters.VertexColor.r));
	MaterialFloat4 Local7 = Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat4 Local8 = Texture2DSampleBias(Material_Texture2D_5, Material_Texture2D_5Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat3 Local9 = lerp(Local7.rgb,Local8.rgb,MaterialFloat(Parameters.VertexColor.r));
	MaterialFloat4 Local10 = Texture2DSampleBias(Material_Texture2D_6, Material_Texture2D_6Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat3 Local11 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Local10.rgb,MaterialFloat(Parameters.VertexColor.g));
	MaterialFloat4 Local12 = Texture2DSampleBias(Material_Texture2D_7, Material_Texture2D_7Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat3 Local13 = lerp(Local12.rgb,Local10.rgb,MaterialFloat(Parameters.VertexColor.r));

	PixelMaterialInputs.EmissiveColor = Local3;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local11;
	...
	PixelMaterialInputs.AmbientOcclusion = Local13;
