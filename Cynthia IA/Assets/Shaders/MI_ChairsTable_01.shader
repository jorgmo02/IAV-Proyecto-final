Shader "Unreal/MI_ChairsTable_01"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.343750,0.343750,0.343750,1.000000);//
	Material.VectorExpressions[3] = float4(0.343750,0.343750,0.343750,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,0.000000);
	Material.ScalarExpressions[1] = float4(0.650000,0.500000,0.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local6 = Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local7 = lerp(Material.ScalarExpressions[1].z,Material.ScalarExpressions[1].y,Local6.g);
