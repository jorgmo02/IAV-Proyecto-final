		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[6] = float4(2.000000,1.649414,0.935663,1.000000);//
	Material.VectorExpressions[7] = float4(2.000000,1.649414,0.935663,0.000000);//
	Material.VectorExpressions[8] = float4(1.623299,2.000000,1.416667,0.000000);//
	Material.VectorExpressions[9] = float4(1.623299,2.000000,1.416667,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,2.000000,0.200000);
	Material.ScalarExpressions[1] = float4(0.300000,1.200000,0.000000,0.800000);
