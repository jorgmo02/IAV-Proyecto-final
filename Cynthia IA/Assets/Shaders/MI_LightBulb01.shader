		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(50.000000,33.311081,9.946593,1.000000);//
	Material.VectorExpressions[2] = float4(50.000000,33.311081,9.946593,0.000000);//
	Material.VectorExpressions[3] = float4(0.000000,0.000000,0.000000,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,0.000000);
	Material.ScalarExpressions[1] = float4(0.500000,1.000000,0.000000,1.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local2 = (MaterialFloat2(Local1.r,Local1.g) * Material.ScalarExpressions[0].y);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = MaterialFloat3(Local2,Local1.b);
	...
	MaterialFloat4 Local3 = Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat3 Local4 = (Local3.r * Material.VectorExpressions[2].rgb);
	MaterialFloat3 Local5 = lerp(Local4,Material.VectorExpressions[3].rgb,MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat4 Local6 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat4 Local7 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local8 = lerp(Material.ScalarExpressions[1].z,Material.ScalarExpressions[1].y,Local7.g);
	MaterialFloat2 Local9 = (Parameters.TexCoords[0].xy * Material.ScalarExpressions[1].w);
	MaterialFloat4 Local10 = Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler,Local9,View.MaterialTextureMipBias);
	MaterialFloat Local11 = (1.00000000 - Local10.r);
