		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.090000,0.085360,0.071438,1.000000);//
	Material.VectorExpressions[5] = float4(0.090000,0.085360,0.071438,0.000000);//
	Material.VectorExpressions[6] = float4(0.860000,0.806740,0.574316,1.000000);//
	Material.VectorExpressions[7] = float4(0.860000,0.806740,0.574316,0.000000);//
	Material.ScalarExpressions[0] = float4(75.000000,1.000000,75.000000,2.000000);
	Material.ScalarExpressions[1] = float4(1.000000,1.000000,0.000000,75.000000);
	Material.ScalarExpressions[2] = float4(1.000000,8.000000,0.300000,0.800000);
	Material.ScalarExpressions[3] = float4(0.000000,8.000000,0.800000,0.900000);
	Material.ScalarExpressions[4] = float4(0.600000,0.000000,0.000000,0.000000);
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local38 = dot(Local37.rgb, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local39 = lerp(Local37.rgb,MaterialFloat3(Local38,Local38,Local38),MaterialFloat(0.50000000));
	MaterialFloat3 Local40 = (Material.VectorExpressions[7].rgb * Local39);
	MaterialFloat3 Local41 = (Local40 * Local8.b);
	MaterialFloat3 Local42 = (Local35 + Local41);
	MaterialFloat Local43 = (Material.ScalarExpressions[2].z * Local8.b);
	MaterialFloat Local44 = (Material.ScalarExpressions[2].w * Local8.g);
	MaterialFloat Local45 = (Local43 + Local44);
	MaterialFloat Local46 = (Material.ScalarExpressions[3].x * Local8.r);
	MaterialFloat Local47 = (Local45 + Local46);
	MaterialFloat2 Local48 = (Parameters.TexCoords[0].xy * Material.ScalarExpressions[3].y);
	MaterialFloat4 Local49 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_8, Material_Texture2D_8Sampler,Local48,View.MaterialTextureMipBias));
	MaterialFloat Local50 = (Material.ScalarExpressions[3].z * Local8.b);
	MaterialFloat3 Local51 = (Local49.rgb * Local50);
	MaterialFloat2 Local52 = (Parameters.TexCoords[0].xy * 2.00000000);
	MaterialFloat4 Local53 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_9, Material_Texture2D_9Sampler,Local52,View.MaterialTextureMipBias));
	MaterialFloat Local54 = (Material.ScalarExpressions[3].w * Local8.g);
	MaterialFloat3 Local55 = (Local53.rgb * Local54);
	MaterialFloat3 Local56 = (Local51 + Local55);
	MaterialFloat4 Local57 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_10, Material_Texture2D_10Sampler,Local52,View.MaterialTextureMipBias));
	MaterialFloat Local58 = (Material.ScalarExpressions[4].x * Local8.r);
	MaterialFloat3 Local59 = (Local57.rgb * Local58);
	MaterialFloat3 Local60 = (Local56 + Local59);
	MaterialFloat4 Local61 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_11, Material_Texture2D_11Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.AmbientOcclusion = Local61.rgb;
