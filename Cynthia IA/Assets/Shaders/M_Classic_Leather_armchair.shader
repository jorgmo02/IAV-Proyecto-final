...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local0 = (Parameters.TexCoords[0].xy * 40.00000000);
	...
	MaterialFloat3 Local2 = (Local1.rgb * MaterialFloat3(MaterialFloat2(1.00000000,1.00000000),0.00000000));
	MaterialFloat4 Local3 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	...
	MaterialFloat3 Local5 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].x));
	...
	MaterialFloat Local7 = dot(Local6.rgb, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local8 = lerp(Local6.rgb,MaterialFloat3(Local7,Local7,Local7),MaterialFloat(0.30000001));
	MaterialFloat4 Local9 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local10 = (0.80000001 * Local9.g);
