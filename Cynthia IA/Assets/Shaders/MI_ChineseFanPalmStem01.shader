Shader "Unreal/MI_ChineseFanPalmStem01"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(1.012916,1.300000,0.582292,1.000000);//
	Material.VectorExpressions[2] = float4(1.012916,1.300000,0.582292,0.000000);//
	Material.VectorExpressions[3] = float4(0.050000,0.050000,0.050000,1.000000);//
	Material.VectorExpressions[4] = float4(0.050000,0.050000,0.050000,0.000000);//
	Material.VectorExpressions[5] = float4(0.000000,0.000000,0.000000,0.000000);//
	Material.VectorExpressions[6] = float4(4.000000,3.286814,1.259804,1.000000);//
	Material.VectorExpressions[7] = float4(4.000000,3.286814,1.259804,0.000000);//
	Material.VectorExpressions[8] = float4(1.000000,0.946881,0.479167,0.000000);//
	Material.VectorExpressions[9] = float4(1.000000,0.946881,0.479167,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.000000,1.000000);
	Material.ScalarExpressions[1] = float4(0.300000,1.000000,0.000000,0.200000);
