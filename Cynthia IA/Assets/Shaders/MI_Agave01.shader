		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.684028,0.684028,0.684028,1.000000);//
	Material.VectorExpressions[2] = float4(0.684028,0.684028,0.684028,0.000000);//
	Material.VectorExpressions[3] = float4(0.015000,0.015000,0.015000,1.000000);//
	Material.VectorExpressions[4] = float4(0.015000,0.015000,0.015000,0.000000);//
	Material.VectorExpressions[5] = float4(0.000000,0.000000,0.000000,0.000000);//
	Material.VectorExpressions[6] = float4(1.500000,1.138592,0.562500,1.000000);//
	Material.VectorExpressions[7] = float4(1.500000,1.138592,0.562500,0.000000);//
	Material.VectorExpressions[8] = float4(0.776042,0.747207,0.307183,0.000000);//
	Material.VectorExpressions[9] = float4(0.776042,0.747207,0.307183,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.000000,0.460737);
	Material.ScalarExpressions[1] = float4(0.700000,1.000000,0.000000,0.800000);
