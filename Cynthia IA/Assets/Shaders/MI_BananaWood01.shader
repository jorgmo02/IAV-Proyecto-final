		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(0.030000,0.030000,0.030000,1.000000);//
	Material.VectorExpressions[4] = float4(0.030000,0.030000,0.030000,0.000000);//
	Material.VectorExpressions[5] = float4(0.000000,0.000000,0.000000,0.000000);//
	Material.VectorExpressions[6] = float4(4.000000,3.286814,1.259803,1.000000);//
	Material.VectorExpressions[7] = float4(4.000000,3.286814,1.259803,0.000000);//
	Material.VectorExpressions[8] = float4(0.776042,0.633139,0.204433,0.000000);//
	Material.VectorExpressions[9] = float4(0.776042,0.633139,0.204433,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.500000,2.000000);
	Material.ScalarExpressions[1] = float4(0.300000,1.000000,0.000000,0.800000);
