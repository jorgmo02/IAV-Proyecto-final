		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.619792,0.323801,0.274387,1.000000);//
	Material.VectorExpressions[3] = float4(0.619792,0.323801,0.274387,0.000000);//
	Material.ScalarExpressions[0] = float4(2.000000,1.000000,0.000000,0.000000);
	Material.ScalarExpressions[1] = float4(0.500000,1.000000,0.000000,0.000000);
