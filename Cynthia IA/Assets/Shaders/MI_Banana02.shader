		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(2.000000,1.643407,0.629902,1.000000);//
	Material.VectorExpressions[5] = float4(2.000000,1.643407,0.629902,0.000000);//
	Material.VectorExpressions[6] = float4(0.776042,0.633139,0.204433,0.000000);//
	Material.VectorExpressions[7] = float4(0.776042,0.633139,0.204433,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.500000,2.000000);
	Material.ScalarExpressions[1] = float4(0.800000,0.600000,0.000000,0.800000);
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local2 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].y));
	...
	MaterialFloat3 Local4 = (Material.VectorExpressions[3].rgb * Local3.rgb);
	MaterialFloat3 Local5 = (Material.VectorExpressions[5].rgb * Local4);
	MaterialFloat3 Local6 = lerp(Parameters.TangentToWorld[2],Parameters.WorldNormal,MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat Local7 = dot(Local6, Parameters.CameraVector);
	...
	MaterialFloat Local12 = (Local11 * (1.00000000 - 0.04000000));
	MaterialFloat Local13 = (Local12 + 0.04000000);
	MaterialFloat3 Local14 = lerp(Local4,Local5,MaterialFloat(Local13));
	MaterialFloat4 Local15 = Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat Local16 = lerp(Material.ScalarExpressions[1].z,Material.ScalarExpressions[1].y,Local15.g);
	MaterialFloat Local17 = (Material.ScalarExpressions[1].w * Local15.b);
	MaterialFloat4 Local18 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	MaterialFloat3 Local19 = (Local4 * Material.VectorExpressions[7].rgb);

	PixelMaterialInputs.EmissiveColor = Local2;
	PixelMaterialInputs.Opacity = Local17;
	PixelMaterialInputs.OpacityMask = Local18.g;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local19,Material.ScalarExpressions[2].x);
