Shader "Unreal/M_Plaster_Planks"
{
	Properties
	{
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local3 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias)).r).rrrr;
	MaterialFloat4 Local4 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias)).r).rrrr;
	...
	PixelMaterialInputs.AmbientOcclusion = Local4.rgb;
