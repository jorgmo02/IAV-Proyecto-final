		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(2.000000,1.000000,1.000000,2.000000);
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,0.000000,0.000000);
	Material.ScalarExpressions[2] = float4(0.100000,0.100000,0.800000,0.000000);
