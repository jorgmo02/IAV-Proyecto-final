		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(2.000000,1.707531,1.055351,1.000000);//
	Material.VectorExpressions[5] = float4(2.000000,1.707531,1.055351,0.000000);//
	Material.VectorExpressions[6] = float4(0.708333,0.649225,0.352174,0.000000);//
	Material.VectorExpressions[7] = float4(0.708333,0.649225,0.352174,0.000000);//
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,3.000000,0.500000);
